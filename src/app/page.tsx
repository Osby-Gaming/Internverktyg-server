  ...
  return (
    <div>
      <div className="md:hidden lg:grid grid-cols-3 grid-rows-2">
        ...
        <Link href={"/vouchers"} className="row-span-1 lg:h-[240px] lg:w-[240px] h-[180px] w-[180px] flex justify-center items-center bg-gray-900 rounded-3xl m-1 cursor-pointer text-2xl select-none">Kuponger</Link>
        <Link href={"/participants/add"} className="row-span-1 lg:h-[240px] lg:w-[240px] h-[180px] w-[180px] flex justify-center items-center bg-gray-900 rounded-3xl m-1 cursor-pointer text-2xl select-none">Deltagare</Link>
